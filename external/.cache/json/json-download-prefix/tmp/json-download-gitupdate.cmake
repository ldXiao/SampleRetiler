...
execute_process(
  COMMAND "/usr/bin/git" show-ref v3.6.1
  WORKING_DIRECTORY "/Users/vector_cat/gits/SampleRetiler/external/json"
...
if("${show_ref_output}" MATCHES "refs/remotes/v3.6.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v3.6.1")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v3.6.1
  WORKING_DIRECTORY "/Users/vector_cat/gits/SampleRetiler/external/json"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/vector_cat/gits/SampleRetiler/external/json/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/vector_cat/gits/SampleRetiler/external/json/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout v3.6.1
      WORKING_DIRECTORY "/Users/vector_cat/gits/SampleRetiler/external/json"
      RESULT_VARIABLE error_code
      )
    if(error_code)
