...
///
    ...
    public:
        ...
        struct Edge {
            ...
            void unregisterTriangle(Triangle *t);
            // sets either the left or right reference to zero when it references the given element
            bool intersectsPlane(const Eigen::RowVector3d &normal, const float &distance,
                                 Eigen::RowVector3d &intersectionPoint);  // convinience function to compute the intersection of the edge with a given plane
            bool intersectsLine(const Eigen::RowVector3d &p1, const Eigen::RowVector3d &p2,
                                Eigen::RowVector3d &intersectionPoint);  // convinience function to compute the intersection of the edge with a given line
            bool intersectsLine(const Eigen::RowVector3d &p1,
                                const Eigen::RowVector3d &p2);  // convinience function to compute the intersection of the edge with a given line without giving back the intersection point
